...
<?php else : ?>
	...
	<?php if( '' != pinboard_get_option( 'facebook_link' ) || '' != pinboard_get_option( 'twitter_link' ) || '' != pinboard_get_option( 'pinterest_link' ) || '' != pinboard_get_option( 'vimeo_link' ) || '' != pinboard_get_option( 'youtube_link' ) || '' != pinboard_get_option( 'flickr_link' ) || '' != pinboard_get_option( 'googleplus_link' ) || '' != pinboard_get_option( 'dribble_link' ) || '' != pinboard_get_option( 'linkedin_link' ) ) : ?>
		<div id="social-media-icons">
			...
			<a class="social-media-icon vimeo" href="<?php echo esc_url( pinboard_get_option( 'vimeo_link' ) ); ?>">Donate Now</a>
			<?php endif; ?>
			...
			<a class="social-media-icon youtube" href="<?php echo esc_url( pinboard_get_option( 'youtube_link' ) ); ?>">YouTube</a>
			<?php endif; ?>
			...
			<a class="social-media-icon dribble" href="<?php echo esc_url( pinboard_get_option( 'dribble_link' ) ); ?>">RSS</a>
			<?php endif; ?>
		</div>
	<?php endif; ?>
<?php endif; ?>